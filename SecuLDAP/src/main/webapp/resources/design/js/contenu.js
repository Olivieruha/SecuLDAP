$(function(){
	...
	$('.lien-contenu').click(function(){
		...
		if($(id).is(':hidden')){ //Si il est caché on le montre
			$('.contenu').hide(200); //Va prendre 500 ms pour cacher tous les articles
			$(id).show(200); //On va recuperer le contenu de href du lien-article sur lequel on vient de cliquer qui correspond à l'id de l'article à montrer
		}
